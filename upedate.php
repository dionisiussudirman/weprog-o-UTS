<?php
// update.php
// Form to update existing penduduk
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "UPDATE penduduk SET nik='$nik', nama='$nama', alamat='$alamat', jenis_kelamin='$jenis_kelamin', tanggal_lahir='$tanggal_lahir' WHERE id=$id";
